        ...
        <div className='w-full flex flex-col gap-8'>
            <div className="flex p-4 pb-0 items-center gap-3">
                ...
                <div className="flex flex-col">
                    <h1 className='text-sm font-bold text-slate-900 uppercase tracking-wider'>{language === "english" ? "Admin Actions" : "एडमिन एक्शन"}</h1>
                    <span className='text-[10px] font-bold text-slate-600 uppercase tracking-widest'>{language === "english" ? "Admin Control Panel" : "एडमिन कंट्रोल पैनल"}</span>
                </div>
            </div>
