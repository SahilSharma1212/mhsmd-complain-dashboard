        ...
        <div className='w-full flex flex-col gap-8'>
            <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                    <h1 className='text-sm font-bold text-slate-700 uppercase tracking-wider'>Administrative Power Actions</h1>
                    <span className='text-[10px] font-bold text-slate-400 uppercase tracking-widest'>System-Level Configuration & Personnel Management</span>
                </div>
            </div>
            ...
            <div className='grid grid-cols-2 max-lg:grid-cols-1 gap-8 w-full items-start'>
                ...
                <div className='bg-white border border-slate-200 rounded-xs shadow-sm overflow-hidden flex flex-col'>
                    ...
                    <div className='flex flex-col gap-5 p-6'>
                        <div className='flex flex-col gap-1.5'>
                            <label className='text-[11px] font-bold text-slate-400 uppercase tracking-wider'>Full Legal Name</label>
                            <input value={addUserDetails.name}
                                ...
                                className='w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xs focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 focus:bg-white transition-all text-xs font-semibold text-slate-700 placeholder:text-slate-300' />
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className='flex flex-col gap-1.5'>
                                <label className='text-[11px] font-bold text-slate-400 uppercase tracking-wider'>Assigned Role</label>
                                <div className='w-full p-2.5 bg-slate-100 border border-slate-200 rounded-xs text-[10px] text-slate-500 font-bold uppercase tracking-widest flex items-center gap-2'>
                            ...
                            <div className='flex flex-col gap-1.5'>
                                <label className='text-[11px] font-bold text-slate-400 uppercase tracking-wider'>Allocated Jurisdiction</label>
                                {user?.role === "SP" ? (
                                    <select value={addUserDetails.thana}
                                        onChange={(e) => setAddUserDetails({ ...addUserDetails, thana: e.target.value })}
                                        className='w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xs focus:ring-4 focus:ring-blue-500/5 focus:border-blue-500 focus:bg-white transition-all text-xs font-semibold text-slate-700'>
                                    ...
                                    <div className='w-full p-2.5 bg-slate-100 border border-slate-200 rounded-xs text-[10px] text-slate-500 font-bold uppercase tracking-widest'>
                ...
                {user?.role === "SP" && (
                    <div className='bg-white border border-slate-200 rounded-xs shadow-sm overflow-hidden flex flex-col'>
                        ...
                        <div className='flex flex-col gap-5 p-6'>
                            <div className='flex flex-col gap-1.5'>
                                <label className='text-[11px] font-bold text-slate-400 uppercase tracking-wider'>Thana Identification Name</label>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className='flex flex-col gap-1.5'>
                                    <label className='text-[11px] font-bold text-slate-400 uppercase tracking-wider'>Contact Hotline</label>
                                ...
                                <div className='flex flex-col gap-1.5'>
                                    <label className='text-[11px] font-bold text-slate-400 uppercase tracking-wider'>City / Region</label>
                            ...
                            <div className='flex flex-col gap-1.5'>
                                <label className='text-[11px] font-bold text-slate-400 uppercase tracking-wider'>Postal Index Number (PIN)</label>
